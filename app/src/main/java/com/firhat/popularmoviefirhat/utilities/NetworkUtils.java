...
public class NetworkUtils {
    ...
    final static String GITHUB_BASE_URL ="https://api.themoviedb.org/3/movie/";
    /**
     * Sample request
    ...
    public static URL buildUrl(String sortBy) {
        Uri builtUri = Uri.parse(GITHUB_BASE_URL+sortBy+"?api_key="+API_KEY+"&language=en-US&page=1")
                .buildUpon()
                .build();
